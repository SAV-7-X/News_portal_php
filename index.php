...
<div class="container-fluid paddding mb-5">
    ...
    <?php if ($trending_article): ?>
    <div class="fh5co_suceefh5co_height">
        <img src="<?php echo htmlspecialchars($trending_article['image']); ?>" alt="Trending News Image"/>
        <div class="fh5co_suceefh5co_height_position_absolute"></div>
        <div class="fh5co_suceefh5co_height_position_absolute_font">
            <div class="">
                <a href="single.php?id=<?php echo $trending_article['id']; ?> class="color_fff"> 
                    <i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo date('M d, Y', strtotime($trending_article['date'])); ?>
                </a>
            </div>
            <div class="">
                <a href="single.php?id=<?php echo $trending_article['id']; ?>" class="fh5co_good_font"> 
                    <?php echo htmlspecialchars($trending_article['title']); ?>
                </a>
            </div>
        </div>
    </div>
    <?php else: ?>
    <div class="fh5co_suceefh5co_height">
        <img src="images/nick-karvounis-78711.jpg" alt="Default Image"/>
        <div class="fh5co_suceefh5co_height_position_absolute"></div>
        <div class="fh5co_suceefh5co_height_position_absolute_font">
            <div class="">
                <a href="#" class="color_fff"> 
                    <i class="fa fa-clock-o"></i>&nbsp;&nbsp;No trending news available
                </a>
            </div>
        </div>
    </div>
...
<div class="col-md-6">
    <div class="row">
        ...
        <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height_2">
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                    <div class="">
                        <a href="single.php?id=<?php echo $article['id']; ?>" class="color_fff"> 
                            <i class="fa fa-clock-o"></i>&nbsp;&nbsp;<?php echo date('M d, Y', strtotime($article['date'])); ?>
                        </a>
                    </div>
                    <div class="">
                        <a href="single.php?id=<?php echo $article['id']; ?>" class="fh5co_good_font_2"> 
        ...
        <?php
        // If we have fewer than 4 articles, fill the remaining spaces with placeholder content
        for ($i = count($latest_articles); $i < 4; $i++):
        ?>
        <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height_2">
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                    <div class="">
                        <a href="#" class="color_fff"> 
                            <i class="fa fa-clock-o"></i>&nbsp;&nbsp;No Date
                        </a>
                    </div>
                    <div class="">
                        <a href="#" class="fh5co_good_font_2">No article available</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Technology News</div>
        </div>
        <div class="owl-carousel owl-theme" id="slider2">
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    ...
                    <div>
                        <a href="single.php?id=<?php echo htmlspecialchars($news['id']); ?>" class="d-block fh5co_small_post_heading">
                            <span class=""><?php echo htmlspecialchars($news['title']); ?></span>
                        </a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> <?php echo date('M d, Y', strtotime($news['date'])); ?></div>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Education News</div>
        </div>
        <div class="owl-carousel owl-theme" id="slider3">
            <?php foreach ($education_news as $news): ?>
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img">
    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="single.php?id=<?php echo htmlspecialchars($article['id']); ?>" class="fh5co_magna py-2">
                        ...
                        <div class="fh5co_consectetur">
                            <?php echo htmlspecialchars(substr($article['para1'], 0, 150)) . '...'; ?>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <?php foreach ($recommended_news as $news): ?>
                <div class="row pb-3">
...
$sql = "SELECT * FROM articles WHERE status = 'published' ORDER BY date DESC LIMIT 9";
$result = $conn->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 col-lg-2">
                ...
                <ul class="footer_menu">
                    <?php foreach ($categories as $category): ?>
                    <li><a href="blog.php?category_id=<?php echo htmlspecialchars($category['id']); ?>" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; <?php echo htmlspecialchars($category['name']); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                ...
                <?php foreach ($latest_articles as $article): ?>
                <a href="single.php?id=<?php echo htmlspecialchars($article['id']); ?>" class="footer_img_post_6">
                    <img src="<?php echo htmlspecialchars($article['image']); ?>" alt="<?php echo htmlspecialchars($article['title']); ?>"/>
                </a>
                <?php endforeach; ?>
            </div>
